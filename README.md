...
**Current release: [`v3.0.1`](https://github.com/ruoka/net4cpp/releases/tag/v3.0.1)** — SemVer tag for the Clang 21 + libc++ modules consume surface. Prior `v1.0` / `v2.0` / `v2.1` tags are historical.
