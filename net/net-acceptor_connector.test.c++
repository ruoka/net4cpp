...
{
    // Register only — do not accept/connect during static init. Soft assertions
    // need an active execution_context; running them from a global constructor
    // aborts test_runner before any scenario starts.
    tester::bdd::scenario("Acceptor and connector round-trip, [net]") = [] {
